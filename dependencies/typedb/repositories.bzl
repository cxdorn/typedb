...
def typeql():
    git_repository(
        name = "typeql",
        remote = "https://github.com/cxdorn/typeql",
        commit = "a27ae0322da91f1d4aafbada4c5c692275bf8dff",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typeql
    )
...
def typedb_behaviour():
    git_repository(
        ...
        commit = "0bc91049386800e96bca40392ff47070c317b5a6",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_behaviour
    )
